...
export const store = reactive({
    ...
    // Dati del form di inserimento tappa
    formData: {
        titolo: '',
        descrizione: '',
        immagine: null,
