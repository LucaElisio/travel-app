        ...
        <table class="table">
            ...
            <tbody>
                <tr v-for="item in store.viaggio">
                    ...
                    <td><button @click="deleteDay(item.giorno)" class="btn btn-outline-danger"><i
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"  @click="saveNewDay" data-bs-dismiss="modal">Salva</button>
                    </div>
                </div>
            </div>
        </div>
